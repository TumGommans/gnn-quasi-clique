...
4. **Generate LaTeX tables**
   ...
   * `results/reproducibility.tex` -> Table 2 in the paper
   * `results/dimacs/dimacs.tex` -> Table 3 in the paper
   * `results/real-life/real_life.tex` -> Table 4 in the paper
   * `results/dimacs/dimacs_appendix.tex` -> Table 6 in the paper
   * `results/dimacs/real_life_appendix.tex` -> Table 7 in the paper
   * `results/gnn/hyperparameters.tex` -> Table 5 in the paper
